...
public:
    ...
    {
        // проверка входа
        if (!player->GetGroup() && (player->GetMapId() == 585 || player->GetMapId() == 550 || player->GetMapId() == 552
            || player->GetMapId() == 553 || player->GetMapId() == 554 || player->GetMapId() == 601
            || player->GetMapId() == 533 || player->GetMapId() == 555 || player->GetMapId() == 632
            || player->GetMapId() == 658 || player->GetMapId() == 668 || player->GetMapId() == 602
            || player->GetMapId() == 615 || player->GetMapId() == 565))
        {
