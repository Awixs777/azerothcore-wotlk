...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature) override
    {
        ...
        if (canStart)
        {
         ...
         //   if (status == QUEST_STATUS_COMPLETE || status == QUEST_STATUS_REWARDED)
                AddGossipItemFor(player, 0, "Попробуем извлечь меч?", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
    ...
    struct npc_hor_leaderAI : public NullCreatureAI
    {
        ...
        void Reset() override
        {
            ...
            {
                first = false;
                events.ScheduleEvent(EVENT_PRE_INTRO_1, 3s);
                events.ScheduleEvent(EVENT_PRE_INTRO_2, 4s);
                events.ScheduleEvent(EVENT_EMOTE_LEADER_1, 4s);
                events.ScheduleEvent(EVENT_TALK_LEADER_1, 4s);
                events.ScheduleEvent(EVENT_PRE_INTRO_3, 5s);
            }
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case EVENT_INTRO_LK_7:
                ...
                events.ScheduleEvent(EVENT_INTRO_LK_8, 1s);
                break;
